...
void test0()
{
    ...
    //auto r_calc = "115792075433823501842443793263061399771433664157882548136689840029851491237887"_bi * "85080976323951684340509092133222744063"_bi;
    //auto r = "9851702828486364818563324618793142874071069701673068683840643356353134720294307442755230526276175865687906849914881"_bi;

    CHECK_EQUAL("6277101735386680415386645696166681019643111135076165353472"_bi * "10384593098099635632385253181489152"_bi, "65185147357365766803707755979441787505577073655208820110962769043030766591955853829413535744"_bi);


    //CHECK_EQUAL("0xffffFFFFffffFFFFffffFFFFffffFFFF"_bi * "0xffffFFFFffffFFFFffffFFFFffffFFFF"_bi, "0xffffFFFFffffFFFFffffFFFFffffFFFE00000000000000000000000000000001"_bi);

    //using i_t = basic_integer<uint8_t, 1>;
    //i_t i0{ "0xffffffff"sv };
    //i_t i1{ "0xff01"sv };
    //CHECK_EQUAL(i0 * i1, i_t{ "0xFF00FFFF00FF"sv});
    //CHECK_EQUAL("162259257486400249557511215054846"_bi * "72057594035830784"_bi, "11692011704510366111109413064310060724731735179264"_bi);
        
    //CHECK_EQUAL("0xffffFFFFffffFFFFffffFFFFffffFFFFffffFFFFffffFFFFffffFFFFffffFFFF"_bi * "0xffffFFFFffffFFFFffffFFFFffffFFFF"_bi, "39402006196394479212279040100143613804963947181228130472524722419237033863643600344381704752381994682191283092455425"_bi);
}
